...
class GmailEmailFetcher {
  ...
  constructor() {
    this.oauth2Client = new google.auth.OAuth2(
      process.env.GOOGLE_GMAIL_CLIENT_ID || process.env.GMAIL_TEST_CLIENT_ID || process.env.GOOGLE_CLIENT_ID,
      process.env.GOOGLE_GMAIL_CLIENT_SECRET || process.env.GMAIL_TEST_CLIENT_SECRET || process.env.GOOGLE_CLIENT_SECRET,
